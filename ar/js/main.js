...
document.querySelectorAll("#action-btn-call-arabic, #action-btn-mobile-call-arabic")?.forEach(element => {
...
document.querySelectorAll("#action-btn-whatsapp-arabic")?.forEach(element => {
    element?.addEventListener("click", async () => {
        try {
            const info = await getUserInfo();
...
document.querySelectorAll("#action-btn-instagram-arabic")?.forEach(element => {
    element?.addEventListener("click", async () => {
        try {
            const info = await getUserInfo();
